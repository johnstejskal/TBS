package view.components.ui.screenPanels 
{
	 ...
	 */
	public class PrePlayPanel extends SuperPanel
	{
		private const DYNAMIC_TA_REF:String = "PrePlayPanel";
		...
		private function init(e:Event):void 
		{
			...
			mc.gotoAndStop("comp");
			TexturePack.createFromMovieClip(mc, DYNAMIC_TA_REF, "TA_skyHeaderTall", null, 1, 1, null, 0)
			var simTop:Image = TexturePack.getTexturePack(DYNAMIC_TA_REF, "TA_skyHeaderTall").getImage();
			this.addChild(simTop);
			
			//-----------------o
			//content
			mc = LaunchPad.getAsset(PublicSettings.DYNAMIC_LIBRARY_UI, "TA_contentPrePlay") as MovieClip;
			TexturePack.createFromMovieClip(mc, DYNAMIC_TA_REF, "TA_contentPrePlay", null, 1, 1, null, 0)
			var simContent:Image = TexturePack.getTexturePack(DYNAMIC_TA_REF, "TA_contentPrePlay").getImage();
