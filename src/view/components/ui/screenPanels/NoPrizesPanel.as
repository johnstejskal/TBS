package view.components.ui.screenPanels 
{
	 ...
	 */
	public class NoPrizesPanel extends SuperPanel
	{
		private const DYNAMIC_TA_REF:String = "NoPrizesPanel";
		...
		private function init(e:Event):void 
		{
			...
			//-------o
			//content Area
			mc = LaunchPad.getAsset(PublicSettings.DYNAMIC_LIBRARY_UI, "TA_contentNoPrizes") as MovieClip;
			TexturePack.createFromMovieClip(mc, DYNAMIC_TA_REF, "TA_contentNoPrizes", null, 1, 1, null, 0)
			_simContent = TexturePack.getTexturePack(DYNAMIC_TA_REF, "TA_contentNoPrizes").getImage();
