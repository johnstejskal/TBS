package com.johnstejskal 
{
	...
	public class StarlingUtil 
	{
		...
		//-----------------------------------------------o
		public static function makeObjectFlash(object:*, time:Number = 1, interval:Number = 500):void
		{
			flashInterval = setInterval(flash, interval);

			TweenLite.delayedCall(time, function():void{  clearInterval(flashInterval);  object.visible = true; })
		...
		public static function stopFlashing(object:*):void
		{
