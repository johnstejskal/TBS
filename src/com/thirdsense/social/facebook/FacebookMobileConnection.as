package com.thirdsense.social.facebook 
{
	...
	public class FacebookMobileConnection 
	{
		...
		private static function logoutHandler( evt:Event ):void
		{
			...
			var url:String = "https://m.facebook.com/dialog/permissions.request?app_id="+ LPSettings.FACEBOOK_APP_ID +"&display=touch&next=http://www.facebook.com/&type=user_agent&perms=publish_stream&fbconnect=1";
